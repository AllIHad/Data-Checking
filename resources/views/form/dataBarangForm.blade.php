                ...
                <form class="form-horizontal" action="{{ isset($dataBarang) ? route('editedDataBarang', $dataBarang->id_produk) : route('dataBarangCreated') }}" method="post">
                    ...
                    <div class="form-group ">
                        <div class="col-md-12">
                            ...
                            <input id="fname" name="id_produk" type="text" placeholder="Produk ID"
                    ...
                    <div class="form-group ">
                        <div class="col-md-12">
                            ...
                            <input id="fname" name="rak" type="text" placeholder="Rak"
                    ...
                    <div class="form-group ">
                        <div class="col-md-12">
                            ...
                            <input id="fname" name="stok" type="text" placeholder="Stok"
                    ...
                    <div class="form-group ">
                        <div class="col-md-12">
                            ...
                            <input id="fname" name="harga_beli" type="text" placeholder="Harga Beli"
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <input id="lname" name="harga_jual" type="text" placeholder="Harga Jual"
                    ...
                    <div class="form-group ">
                        <div class="col-md-12">
                            ...
                            <input id="fname" name="nama_produk" type="text" placeholder="Nama Produk"
